...
export default function MovieCard({
  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="absolute top-3 left-3 flex flex-col gap-1 z-20"> {/* Increased z-index */}
        {order !== undefined && (
          <div className="bg-indigo-600 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center shadow-lg text-sm">
            {order}
          </div>
        )}
        <div className="bg-yellow-500 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center shadow-lg text-sm">
          {movie.points || 0}
        </div>
      </div>
      <div
        ref={cardRef}
        className={`perspective-1000 h-[400px] cursor-pointer ${isMobile ? "" : "group"
          }`}
            ...
            <div className="flex flex-col justify-between h-full p-6 relative">
              ...
              >
                ...
                <div className="flex items-center mt-4">
                  <span className="text-sm font-medium text-gray-300 mr-2">Views:</span>
                  <div className="flex items-center">
                    <svg className="w-4 h-4 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                    <span className="text-white font-medium">{movie.points || 0}</span>
                  </div>
                </div>
              </div>
            </div>
...
//   return (
//     <div className="flex flex-col space-y-4">
//       {/* Add order badge to the card */}
//       {order !== undefined && (
//         <div className="absolute top-3 left-3 bg-indigo-600 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center shadow-lg z-10 text-sm">
//           {order}
//         </div>
//       )}
